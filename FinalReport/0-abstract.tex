...
The system enables the rich and fine-grained access control by using attribute-based encryption (ABE), and is designed to be deployed on Named Data Networking (NDN).
NDN's content-centric authentication enhances the system security and the semantic name of network-layer packet provides flexible and simple way to organize the virtual organization.
Also, our system supports efficient content multicast and express distribution of keys.
